...
function defineMenus(){
  ...
  {
    "text": '<ui t_id="open_network_flux"></ui>',
    "events": {
      "click": function(e){
  ...
  {
    "text": '<ui t_id="vfc/vfc"></ui>',
    "sub": [
      {
        "text": '<ui t_id="vfc/vfc_capture_current"></ui>',
        "events": {
          "click": function(e){
      ...
      {
        "text": '<ui t_id="vfc/vfc_capture_custom"></ui>',
        "events": {
          "click": function(e){
            viewer.takeCaptureOfVideoElementAtTime(Number(viewer.hms2s(popups.prompt(ui_translator.getDialogInLanguage('vfc_custom')))));
          }
        }
      }
    ]
