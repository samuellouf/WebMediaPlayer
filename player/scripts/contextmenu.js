...
function defineMenus() {
  window.videoMenu = [
    // translate
    {
      text: '<ui t_id="controls/play_pause"></ui>',
      events: {
        click: function (e) {
    ...
    {
      text: '<ui t_id="controls/set_mode_to"></ui>',
      sub: [
        {
          text: '<ui t_id="filetype/image"></ui>',
          events: {
            click: function (e) {
              viewer.mode = "image";
            },
        ...
        {
          text: '<ui t_id="filetype/video"></ui>',
          events: {
            click: function (e) {
              viewer.mode = "video";
            },
        ...
        {
          text: '<ui t_id="filetype/audio"></ui>',
          events: {
            click: function (e) {
              viewer.mode = "audio";
            },
    ...
    {
      text: '<ui t_id="controls/fullscreen_on_off"></ui>',
      events: {
        click: function (e) {
    ...
    {
      text: '<ui t_id="controls/picture_in_picture_on_off"></ui>',
      events: {
        click: function (e) {
    ...
    {
      text: '<ui t_id="controls/loop_on_off"></ui>',
      events: {
        click: function (e) {
          viewer.toggleLoop();
        },
    ...
    },
    {
      ...
      sub: [
        {
          text: '<ui t_id="controls/mute_on_off"></ui>',
          events: {
            click: function (e) {
              viewer.toggleMute();
            },
        ...
        {
          text: '<ui t_id="controls/set_volume_to"></ui>',
          events: {
            click: function (e) {
              viewer.volume = "custom";
            },
          },
        },
      ],
    ...
    {
      text: '<ui t_id="controls/change_speed"></ui>',
      sub: [
        {
          text: "0.25x",
          events: {
    ...
    {
      text: '<ui t_id="file_uploads/import_file"></ui>',
      events: {
        click: function (e) {
          viewer.importFile();
        },
      ...
      sub: [
        {
          text: '<ui t_id="file_uploads/import_file_in_current_tab"></ui>',
          events: {
            click: function (e) {
              viewer.importFile();
            },
        ...
        {
          text: '<ui t_id="file_uploads/import_file_in_new_tab"></ui>',
          events: {
            click: function (e) {
              viewer.importFileInNewTab();
            },
          },
        },
      ],
    ...
    {
      text: '<ui t_id="controls/open_network_flux"></ui>',
      events: {
        click: function (e) {
    ...
    {
      text: '<ui t_id="vfc/_"></ui>',
      sub: [
        {
          text: '<ui t_id="vfc/capture_current"></ui>',
          events: {
            click: function (e) {
        ...
        {
          text: '<ui t_id="vfc/capture_custom"></ui>',
          events: {
            click: function (e) {
              viewer.takeCaptureOfVideoElementAtTime(
                Number(
                  viewer.hms2s(
                    popups.prompt(
                      ui_translator.getDialogInLanguage("vfc_custom"),
                    ),
                  ),
                ),
              );
  ...
  if (viewer.hasAudioTracks() && viewer.getAudioTracks().length > 0)
    window.videoMenu.push(viewer.getAudioTracksMenu());
  if (viewer.hasVideoTracks() && viewer.getVideoTracks().length > 0)
    window.videoMenu.push(viewer.getVideoTracksMenu());

  window.videoMenu.push({
    text: '<ui t_id="settings/_"></ui>',
    events: {
      click: function (e) {
